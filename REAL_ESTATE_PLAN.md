# House-Hack Blueprint: FHA Multi-Unit Purchase Plan (San Antonio, TX)

*Prepared September 2026. Planning model only — verify every figure with a licensed mortgage loan officer, a CPA, and the Bexar County Appraisal District before making an offer.*

## The verdict, up front

Goal: buy a 2–4 unit property north of Hwy 90 and inside Loop 1604, live in one unit, rent the rest, using FHA 3.5%-down financing, while preserving spending power and maximizing monthly cash flow to reinvest.

**Recommendation: a duplex, not a triplex or quadplex.** At current San Antonio prices, rent hasn't risen fast enough relative to purchase price for a typical 3–4 unit property to pass FHA's self-sufficiency test, and even when it does, the required 3-month PITI reserve pushes total cash-to-close to $35,000–$60,000+ — well past current savings. A duplex has no self-sufficiency test and no FHA reserve requirement, and is achievable for roughly $19,000–$26,000 cash to close.

**The one exception worth hunting for:** a triplex priced near $95–100k/unit with combined rent near $1,300/unit clears every FHA test and would cover ~95% of the payment with tenant rent. It's a below-average deal you'd have to find — treat it as a stretch goal, not a plan to count on.

## How the FHA math works

1. **3.5% down, 1.75% upfront MIP.** A 740+ credit score qualifies for FHA's minimum down payment. Upfront MIP (1.75% of loan) is typically financed into the loan. Annual MIP runs ~0.55%/year of the loan balance at this down payment level, for the life of the loan.
2. **DTI ceiling: 43% standard, up to ~50% with compensating factors** (740+ credit, cash reserves).
3. **Rental income add-back:** for any 2–4 unit owner-occupied property, a lender can count 75% of market rent from the unit(s) you don't occupy as extra qualifying income.
4. **Self-sufficiency test — 3 & 4 unit properties only:** 75% of market rent for *every* unit, including the one you occupy, must alone cover full PITI + MIP. Pass/fail; personal income cannot fix a property that fails it. Duplexes are exempt.

## Your numbers today

| Input | Value | Note |
|---|---|---|
| Gross income | $7,276/mo | $87,315/yr |
| Credit score | 740+ | Best available FHA pricing tier |
| Counted monthly debt | $300 | Federal student loan; cards run to $0 before statement; 401(k) loan deduction doesn't count |
| Cash today | ~$10,000 | Own savings |
| Cash by June 2027 | $25,000–35,000 | Own savings ($15–20k) + mother's $15k |
| Current FHA 30-yr rate | ~6.0% | Range 5.75–6.25% by lender; get 3+ quotes |
| Max housing payment @ 43% DTI | ~$3,200–3,300/mo | Before rental income add-back |
| Max housing payment @ 50% DTI | ~$3,800–3,900/mo | With reserves + credit as compensating factors |

Income comfortably qualifies for every scenario below — DTI is not the binding constraint. **Cash-to-close and the self-sufficiency test are the real gates.**

## Scenario comparison

Modeled at 3.5% down, 6.0% FHA 30-yr, blended 2.4% property tax, landlord insurance estimates, 0.55% annual MIP, 3% closing costs + $2,800 prepaids.

| Scenario | Price | Payment/mo | Tenant rent/mo | Your share/mo | Cash needed | DTI | Self-sufficiency |
|---|---|---|---|---|---|---|---|
| Duplex — Tier 2 | $260,000 | $2,356 | $1,200 | $1,156 | $19,700 | Pass | N/A |
| Duplex — Tier 1 | $360,000 | $3,189 | $1,550 | $1,639 | $26,200 | Pass | N/A |
| Triplex — Tier 2, typical | $360,000 | $3,229 | $2,100 | $1,129 | $35,900 | Pass | **Fail** |
| Triplex — stretch deal* | $300,000 | $2,729 | $2,600 | $129 | $30,500 | Pass | Pass |
| Quadplex — Tier 2 | $460,000 | $4,101 | $3,000 | $1,101 | $45,000 | Borderline | **Fail** |
| Quadplex — Tier 1 | $650,000 | $5,684 | $3,900 | $1,784 | $62,100 | **Fail** | **Fail** |

*The triplex "stretch deal" needs three ~$1,300/mo units on a $300k purchase (~$100k/unit) — realistic for this market, not guaranteed.
...
**Tier 1 (premium, strongest rent):**
- **Tobin Hill** — median multi-family ~$438k; walkable to the Pearl, San Antonio College, downtown; best renter demand, strongest appreciation.
- **Government Hill / Mahncke Park** — adjacent to Tobin Hill/Broadway corridor; similar rent strength, slightly more negotiating room.

**Tier 2 (entry price, best rent-to-price ratio):**
- **Dignowity Hill** — median multi-family ~$325k (range $115k–$1.3M reflects condition spread); gentrifying near-east-side; where the triplex stretch deal math is most plausible.
- **Denver Heights / Eastside** — lowest entry prices, rents climbing toward downtown-adjacent levels.
- **Highland Park** — multi-family range $125k–$525k; several small rehabbed 2–3 unit properties have traded recently.
- **Beacon Hill / Los Angeles Heights** — just outside downtown's northwest edge, easier duplex inventory than Tobin Hill.

## On finding actual listings

This plan was built without live MLS/Zillow/Redfin data access, so it does not include verified current addresses — treat any specific address as something to verify, not to trust blind. Recommended next steps:

- Set up saved searches on **Zillow** and **Redfin**: San Antonio, TX → Multi-family → $200k–$400k → draw a custom map boundary along Loop 1604 and Hwy 90 (zip codes don't line up cleanly with this boundary). Turn on alerts.
- Search directly by neighborhood name for the six neighborhoods above.
- Interview 2–3 buyer's agents and ask directly how many owner-occupied 2–4 unit FHA deals they've closed in the last 12 months — you want someone who already knows which local lenders handle the self-sufficiency test smoothly.
- Once you have a specific address, price, and rent estimate, run it through this same model before making an offer.

## Scaling to property #2

FHA requires occupying the property as your primary residence, typically for at least 12 months. After that, you can move out, convert unit 1 fully to a rental, and buy your next primary residence with another 3.5%-down FHA loan — using standard rental-income rules on the new property, plus the now fully-rented income from property #1 as qualifying income. This is the standard way small investors scale on FHA without 20–25% down each time.
...
6.0% FHA 30-year fixed rate (shop this; market range seen was 5.75–6.25% in September 2026); property tax modeled at a blended 2.4% of price (actual bill depends on final appraised value and how much of the homestead exemption applies to your owner-occupied share — get a precise estimate from Bexar County Appraisal District once you have an address); landlord insurance estimated at $190/mo (duplex), $230/mo (triplex), $270/mo (quadplex) — get real quotes; annual MIP at 0.55% of base loan; 3% buyer-side closing costs plus $2,800 prepaid escrow.
